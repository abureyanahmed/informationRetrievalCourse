...
case class parseMyQuery3words(term1: String, term2: String, operator1: String, operator2: String, term3: String) {
...
class SimpleParser extends RegexParsers {
  ...
  def parWordOperator: Parser[parseMyQuery3words] = parenthesis ~ word ~ operator ~ word  ~ parenthesis   ~ operator ~ word   ^^ { case lpar ~ wd1 ~op1 ~ wd2 ~ rpar ~op2 ~wd3=> parseMyQuery3words(wd1,wd2,op1,op2,wd3) }
