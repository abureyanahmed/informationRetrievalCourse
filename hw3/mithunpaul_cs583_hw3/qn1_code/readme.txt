...
Note: If you plan to test more boolean queries, please make sure they are all in the same argument. If there are more than 3 arguments, my code assumes that the 4th argument is the proximity distance. i.e proximity queries will only work when there are 4 arguments. So to test just the two words information retrieval with proximity, you will have to specify a null argument explicitly like this:
